    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          {error && (
            <div className="mb-6 p-4 bg-destructive/10 border border-destructive/20 rounded-xl text-destructive text-sm animate-fade-in">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              className="btn-auth-primary h-12 rounded-xl font-medium"
              disabled={isLoading}
            >
              {isLoading ? (
          ...
          <Button
            ...
            className="btn-auth-google h-12 rounded-xl font-medium"
