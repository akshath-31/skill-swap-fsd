...
export const SkillCard = ({ skill, onViewDetails }) => {
    ...
    return (<div className="card-skill animate-fade-in group">
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center">
          {skill.teacher.avatar ? (<img src={skill.teacher.avatar} alt={skill.teacher.name} className="w-full h-full rounded-full object-cover"/>) : (<User className="w-4 h-4 text-secondary-foreground"/>)}
        </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-border">
        ...
        <Button onClick={() => onViewDetails(skill)} variant="outline" size="sm" className="rounded-lg hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all">
          View Details
        </Button>
      </div>
    </div>);
};
export const SkillCardSkeleton = () => (<div className="card-skill">
    <div className="flex items-start justify-between mb-3">
